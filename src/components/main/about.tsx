    ...
    return (
        <div>
            ...
            <Text>
                ...
                <p>
                    По вопросам оптовых продаж, работы с дилерами и производству продукции по индивидуальным заказам просьба писать на электронный адрес i.sataeva@pmk-team.ru.
                </p>
            </Text>
        </div>
    );
