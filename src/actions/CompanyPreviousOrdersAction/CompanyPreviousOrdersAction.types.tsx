...
export const GET_COMPANY_PREVIOUS_ORDERS_REQUEST = 'GET_PREVIOUS_ORDERS_REQUEST';
export const GET_COMPANY_PREVIOUS_ORDERS_SUCCESS = 'GET_PREVIOUS_ORDERS_SUCCESS';
export const GET_COMPANY_PREVIOUS_ORDERS_FAIL = 'GET_PREVIOUS_ORDERS_FAIL';
